...
| `format.separate_counties_voter_file` | boolean | `true|false` | (No reference in code???)                                                  | `true`  |
| `format.separate_counties_hist_file`  | boolean | `true|false` | (No reference in code???)                                                  | `true`  |
| `format.hist_election_rows`           | boolean | `true|false` | (No reference in code???)                                                  | `true`  |
...
| `democratic_party`     | string, list of strings? |        | The name of the value(s) that defines the Democratic party.                                                                                                                     | `DFL`               |
| `republican_party`     | string, list of strings? |        | The name of the value(s) that defines the Democratic party.                                                                                                                     | `GOP`               |
| `libertarian_party`    | string, list of strings? |        | The name of the value(s) that defines the Libertarian party.                                                                                                                    | `lib`               |
| `no_party_affiliation` | string, list of strings? |        | The name of the value(s) that defines the Democratic party.                                                                                                                     | `Unaffiliated`      |

...
from reggie.ingestion.download import ErrorLog, FileItem, concat_and_delete, FileItem, Preprocessor, date_from_str
import logging
import pandas as pd
import datetime
    ...
    def __init__(self, raw_s3_file, config_file, force_date=None, **kwargs):
        ...
        for i in remaining_files:
            ...
            new_df = self.read_csv_count_error_lines(i["obj"], header=None,
                                                     skiprows=skiprows, names=headers_with_buffers,
        ...
        self.processed_file = FileItem(name="{}.processed".format(self.config["state"]),
